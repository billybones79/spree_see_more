  ...
  Deface::Override.new(:virtual_path=>'spree/shared/_products_list',
        ...
        <%= link_to_next_page products, t('spree.product_list.see_more'), params: params.permit(params.keys), remote: true,  data: {disable_with: \"<i class='fa fa-refresh fa-spin'></i> ...\".html_safe } %>
      </div>")